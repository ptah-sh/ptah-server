...
13	1	2	5	{"deploymentId": 1}	{"caddy": {"apps": {"http": {"servers": {"http": {"listen": ["0.0.0.0:80"], "routes": [{"match": [{"host": ["*"], "path": ["/*"]}], "handle": [{"handler": "ptah_observer", "rule_id": "ptah_404", "process_id": "ptah_404", "service_id": "ptah_404"}, {"body": "<!DOCTYPE html>\\n<html>\\n<head>\\n    <title>404 Not Found</title>\\n    <style>\\n        body {\\n            text-align: center;\\n            font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;\\n            height: 100vh;\\n            display: flex;\\n            flex-direction: column;\\n            align-items: center;\\n            justify-content: space-evenly;\\n        }\\n\\n        .home-btn {\\n            display: inline-block;\\n            visibility: hidden;\\n            background-color: #007bff;\\n            color: #fff;\\n            padding: 10px 20px;\\n            border-radius: 5px;\\n            text-decoration: none;\\n            margin-top: 20px;\\n        }\\n\\n        .home-btn:hover {\\n            background-color: #0069d9;\\n        }\\n\\n        .powered-by {\\n            margin-top: 20px;\\n            color: #999;\\n        }\\n    </style>\\n\\n    <script>\\n        window.addEventListener('DOMContentLoaded', () => {\\n            if (window.location.pathname !== \\"/\\") {\\n                document.getElementById('goHome').style.visibility = 'visible';\\n            }\\n        })\\n    </script>\\n</head>\\n<body>\\n    <div>\\n        <h1>404 Not Found</h1>\\n        <p>The requested URL was not found on this server.</p>\\n\\n        <p>Please contact the server administrator if you believe this is an error.</p>\\n\\n        <a id=\\"goHome\\" class=\\"home-btn\\" href=\\"/\\">Return to the Home Page</a>\\n    </div>\\n\\n    <p class=\\"powered-by\\"><small>Powered by <a href=\\"https://ptah.sh\\">ptah.sh</a></small></p>\\n</body>\\n</html>", "handler": "static_response", "headers": {"Content-Type": ["text/html; charset=utf-8"], "X-Powered-By": ["https://ptah.sh"]}, "status_code": "404"}]}]}, "https": {"listen": ["0.0.0.0:443"], "routes": [{"match": [{"host": ["*"], "path": ["/*"]}], "handle": [{"handler": "ptah_observer", "rule_id": "ptah_404", "process_id": "ptah_404", "service_id": "ptah_404"}, {"body": "<!DOCTYPE html>\\n<html>\\n<head>\\n    <title>404 Not Found</title>\\n    <style>\\n        body {\\n            text-align: center;\\n            font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;\\n            height: 100vh;\\n            display: flex;\\n            flex-direction: column;\\n            align-items: center;\\n            justify-content: space-evenly;\\n        }\\n\\n        .home-btn {\\n            display: inline-block;\\n            visibility: hidden;\\n            background-color: #007bff;\\n            color: #fff;\\n            padding: 10px 20px;\\n            border-radius: 5px;\\n            text-decoration: none;\\n            margin-top: 20px;\\n        }\\n\\n        .home-btn:hover {\\n            background-color: #0069d9;\\n        }\\n\\n        .powered-by {\\n            margin-top: 20px;\\n            color: #999;\\n        }\\n    </style>\\n\\n    <script>\\n        window.addEventListener('DOMContentLoaded', () => {\\n            if (window.location.pathname !== \\"/\\") {\\n                document.getElementById('goHome').style.visibility = 'visible';\\n            }\\n        })\\n    </script>\\n</head>\\n<body>\\n    <div>\\n        <h1>404 Not Found</h1>\\n        <p>The requested URL was not found on this server.</p>\\n\\n        <p>Please contact the server administrator if you believe this is an error.</p>\\n\\n        <a id=\\"goHome\\" class=\\"home-btn\\" href=\\"/\\">Return to the Home Page</a>\\n    </div>\\n\\n    <p class=\\"powered-by\\"><small>Powered by <a href=\\"https://ptah.sh\\">ptah.sh</a></small></p>\\n</body>\\n</html>", "handler": "static_response", "headers": {"Content-Type": ["text/html; charset=utf-8"], "X-Powered-By": ["https://ptah.sh"]}, "status_code": "404"}]}]}}}}}}	completed	2024-09-01 00:00:00	2024-09-01 00:00:00	[]	2024-09-01 00:00:00	2024-09-01 00:00:00
16	1	3	14	{"dockerImage": "bitnami/pgbouncer"}	{"Image": "bitnami/pgbouncer", "PullOptions": {}, "AuthConfigName": ""}	completed	2024-09-01 00:00:00	2024-09-01 00:00:00	[]	2024-09-01 00:00:00	2024-09-01 00:00:00
14	1	3	14	{"dockerImage": "bitnami/postgresql:16"}	{"Image": "bitnami/postgresql:16", "PullOptions": {}, "AuthConfigName": ""}	completed	2024-09-01 00:00:00	2024-09-01 00:00:00	[]	2024-09-01 00:00:00	2024-09-01 00:00:00
18	1	3	14	{"dockerImage": "victoriametrics/victoria-metrics"}	{"Image": "victoriametrics/victoria-metrics", "PullOptions": {}, "AuthConfigName": ""}	completed	2024-09-01 00:00:00	2024-09-01 00:00:00	[]	2024-09-01 00:00:00	2024-09-01 00:00:00
20	1	3	14	{"dockerImage": "ghcr.io/ptah-sh/ptah-server:latest"}	{"Image": "ghcr.io/ptah-sh/ptah-server:latest", "PullOptions": {}, "AuthConfigName": ""}	completed	2024-09-01 00:00:00	2024-09-01 00:00:00	[]	2024-09-01 00:00:00	2024-09-01 00:00:00
...
24	1	3	8	{"serviceId": 1, "dockerName": "svc_1_ptah_caddy", "serviceName": "ptah"}	{"ServiceName": "svc_1_ptah_caddy"}	completed	2024-09-01 00:00:00	2024-09-01 00:00:00	[]	2024-09-01 00:00:00	2024-09-01 00:00:00
25	1	3	8	{"serviceId": 1, "dockerName": "svc_1_ptah_registry", "serviceName": "ptah"}	{"ServiceName": "svc_1_ptah_registry"}	completed	2024-09-01 00:00:00	2024-09-01 00:00:00	[]	2024-09-01 00:00:00	2024-09-01 00:00:00
...
SELECT pg_catalog.setval('public.node_tasks_id_seq', 26, true);
