...
17	1	3	21	{"serviceId": 2, "dockerName": "svc_2_ptah_ptah_server_wkr_scheduler", "serviceName": "ptah", "deploymentId": 2}	{"SecretVars": {}, "ReleaseCommand": {"Command": "", "ConfigName": "", "ConfigLabels": {}}, "SwarmServiceSpec": {"Mode": {"Replicated": {"Replicas": 1}}, "Name": "svc_2_ptah_ptah_server_wkr_scheduler", "Labels": {"sh.ptah.kind": "worker", "sh.ptah.cookie": "jxTwFjRiesats3Yla9DBWWG9vqns2YcD", "sh.ptah.managed": "1", "sh.ptah.service.id": "2", "sh.ptah.worker.name": "scheduler", "sh.ptah.process.name": "ptah-server", "sh.ptah.service.slug": "ptah_happy_ptah_2", "sh.ptah.deployment.id": "2"}, "EndpointSpec": {"Ports": []}, "TaskTemplate": {"Networks": [{"Target": "ptah_net", "Aliases": ["scheduler.ptah-server.server.ptah.local", "dpl-2.scheduler.ptah-server.server.ptah.local"]}], "ContainerSpec": {"Env": ["APP_ENV=production", "APP_KEY=base64:APP_KEY", "BCRYPT_ROUNDS=12", "DB_CONNECTION=pgsql", "DB_HOST=pool.server.ptah.local", "DB_DATABASE=ptah_sh", "DB_USERNAME=ptah_sh", "DB_PASSWORD=ptah_sh", "LOG_CHANNEL=errorlog", "APP_URL=localhost", "BILLING_ENABLED=false", "VICTORIAMETRICS_URL=http://victoriametrics.server.ptah.local:8428", "PTAH_INTERNAL_DOMAIN=scheduler.ptah-server.server.ptah.local", "PTAH_HOSTNAME=dpl-2.scheduler.ptah-server.server.ptah.local", "PTAH_DEPLOYMENT_ID=2", "PTAH_SERVICE_ID=ptah_happy_ptah_2", "PTAH_PROCESS_NAME=ptah-server", "PTAH_WORKER_NAME=scheduler"], "Args": ["-c", "APP_SCHEDULER=main php artisan config:cache && php artisan schedule:work"], "Hosts": ["scheduler.ptah-server.server.ptah.local"], "Image": "ghcr.io/ptah-sh/ptah-server:latest", "Labels": {"sh.ptah.kind": "worker", "sh.ptah.cookie": "jxTwFjRiesats3Yla9DBWWG9vqns2YcD", "sh.ptah.managed": "1", "sh.ptah.service.id": "2", "sh.ptah.worker.name": "scheduler", "sh.ptah.process.name": "ptah-server", "sh.ptah.service.slug": "ptah_happy_ptah_2", "sh.ptah.deployment.id": "2"}, "Mounts": [], "Command": ["sh"], "Configs": [], "Secrets": [], "Hostname": "dpl-2.scheduler.ptah-server.server.ptah.local", "Placement": [], "HealthCheck": null}, "RestartPolicy": {"Condition": "any"}}}}	completed	2024-09-01 00:00:00	2024-09-01 00:00:00	[]	2024-09-01 00:00:00	2024-09-01 00:00:00
7	1	2	21	{"serviceId": 1, "dockerName": "caddy", "serviceName": "caddy", "deploymentId": 1}	{"SecretVars": {}, "ReleaseCommand": {"Command": "", "ConfigName": "", "ConfigLabels": {}}, "SwarmServiceSpec": {"Mode": {"Replicated": {"Replicas": 1}}, "Name": "caddy", "Labels": {"sh.ptah.kind": "worker", "sh.ptah.cookie": "67xaqM7HWSdBqtxxonVYXq7NyESIDRHK", "sh.ptah.managed": "1", "sh.ptah.service.id": "1", "sh.ptah.worker.name": "main", "sh.ptah.process.name": "svc", "sh.ptah.service.slug": "caddy_happy_ptah_1", "sh.ptah.deployment.id": "1"}, "EndpointSpec": {"Ports": [{"Protocol": "tcp", "TargetPort": 80, "PublishMode": "ingress", "PublishedPort": 80}, {"Protocol": "tcp", "TargetPort": 443, "PublishMode": "ingress", "PublishedPort": 443}, {"Protocol": "tcp", "TargetPort": 2019, "PublishMode": "ingress", "PublishedPort": 2019}]}, "TaskTemplate": {"Networks": [{"Target": "ptah_net", "Aliases": ["svc.caddy.ptah.local", "dpl-1.main.svc.caddy.ptah.local"]}], "ContainerSpec": {"Env": ["CADDY_ADMIN=0.0.0.0:2019", "PTAH_INTERNAL_DOMAIN=svc.caddy.ptah.local", "PTAH_HOSTNAME=dpl-1.main.svc.caddy.ptah.local", "PTAH_DEPLOYMENT_ID=1", "PTAH_SERVICE_ID=caddy_happy_ptah_1", "PTAH_PROCESS_NAME=svc", "PTAH_WORKER_NAME=main"], "Args": ["-c", "sh /start.sh"], "Hosts": ["svc.caddy.ptah.local"], "Image": "ghcr.io/ptah-sh/ptah-caddy:latest", "Labels": {"sh.ptah.kind": "worker", "sh.ptah.cookie": "67xaqM7HWSdBqtxxonVYXq7NyESIDRHK", "sh.ptah.managed": "1", "sh.ptah.service.id": "1", "sh.ptah.worker.name": "main", "sh.ptah.process.name": "svc", "sh.ptah.service.slug": "caddy_happy_ptah_1", "sh.ptah.deployment.id": "1"}, "Mounts": [{"Type": "volume", "Source": "svc_1_caddy_svc_data", "Target": "/data", "VolumeOptions": {"Labels": {"sh.ptah.managed": "1", "sh.ptah.volume.id": "volume-a1b2c3d4e5f", "sh.ptah.service.id": "1", "sh.ptah.volume.path": "/data", "sh.ptah.process.name": "svc", "sh.ptah.service.slug": "caddy_happy_ptah_1", "sh.ptah.deployment.id": "1"}}}, {"Type": "volume", "Source": "svc_1_caddy_svc_config", "Target": "/config", "VolumeOptions": {"Labels": {"sh.ptah.managed": "1", "sh.ptah.volume.id": "volume-g6h7i8j9k1", "sh.ptah.service.id": "1", "sh.ptah.volume.path": "/config", "sh.ptah.process.name": "svc", "sh.ptah.service.slug": "caddy_happy_ptah_1", "sh.ptah.deployment.id": "1"}}}], "Command": ["sh"], "Configs": [{"File": {"GID": "0", "UID": "0", "Mode": 511, "Name": "/ptah/caddy/tls/.keep"}, "ConfigName": "svc_1_caddy_svc_dpl_1_cfg_ptah_caddy_tls_keep"}, {"File": {"GID": "0", "UID": "0", "Mode": 511, "Name": "/start.sh"}, "ConfigName": "svc_1_caddy_svc_dpl_1_cfg_start_sh"}], "Secrets": [], "Hostname": "dpl-1.main.svc.caddy.ptah.local", "Placement": {"Constraints": ["node.labels.sh.ptah.node.id==1"]}, "HealthCheck": null}, "RestartPolicy": {"Condition": "any"}}}}	completed	2024-09-01 00:00:00	2024-09-01 00:00:00	[]	2024-09-01 00:00:00	2024-09-01 00:00:00
16	1	3	21	{"serviceId": 2, "dockerName": "svc_2_ptah_ptah_server_wkr_main", "serviceName": "ptah", "deploymentId": 2}	{"SecretVars": {}, "ReleaseCommand": {"Command": "php artisan config:cache && php artisan migrate --no-interaction --verbose --ansi --force", "ConfigName": "svc_2_ptah_ptah_server_rel_cmd", "ConfigLabels": {"sh.ptah.kind": "release-command", "sh.ptah.cookie": "yXRZlfeykt28fXXHALAZRAxVhDJBGc0q", "sh.ptah.managed": "1", "sh.ptah.service.id": "2", "sh.ptah.worker.name": "main", "sh.ptah.process.name": "ptah-server", "sh.ptah.service.slug": "ptah_happy_ptah_2", "sh.ptah.deployment.id": "2"}}, "SwarmServiceSpec": {"Mode": {"Replicated": {"Replicas": 2}}, "Name": "svc_2_ptah_ptah_server_wkr_main", "Labels": {"sh.ptah.kind": "worker", "sh.ptah.cookie": "yXRZlfeykt28fXXHALAZRAxVhDJBGc0q", "sh.ptah.managed": "1", "sh.ptah.service.id": "2", "sh.ptah.worker.name": "main", "sh.ptah.process.name": "ptah-server", "sh.ptah.service.slug": "ptah_happy_ptah_2", "sh.ptah.deployment.id": "2"}, "EndpointSpec": {"Ports": []}, "TaskTemplate": {"Networks": [{"Target": "ptah_net", "Aliases": ["ptah-server.server.ptah.local", "dpl-2.main.ptah-server.server.ptah.local"]}], "ContainerSpec": {"Env": ["APP_ENV=production", "APP_KEY=base64:APP_KEY", "BCRYPT_ROUNDS=12", "DB_CONNECTION=pgsql", "DB_HOST=pool.server.ptah.local", "DB_DATABASE=ptah_sh", "DB_USERNAME=ptah_sh", "DB_PASSWORD=ptah_sh", "LOG_CHANNEL=errorlog", "APP_URL=localhost", "BILLING_ENABLED=false", "VICTORIAMETRICS_URL=http://victoriametrics.server.ptah.local:8428", "PTAH_INTERNAL_DOMAIN=ptah-server.server.ptah.local", "PTAH_HOSTNAME=dpl-2.main.ptah-server.server.ptah.local", "PTAH_DEPLOYMENT_ID=2", "PTAH_SERVICE_ID=ptah_happy_ptah_2", "PTAH_PROCESS_NAME=ptah-server", "PTAH_WORKER_NAME=main"], "Args": null, "Hosts": ["ptah-server.server.ptah.local"], "Image": "ghcr.io/ptah-sh/ptah-server:latest", "Labels": {"sh.ptah.kind": "worker", "sh.ptah.cookie": "yXRZlfeykt28fXXHALAZRAxVhDJBGc0q", "sh.ptah.managed": "1", "sh.ptah.service.id": "2", "sh.ptah.worker.name": "main", "sh.ptah.process.name": "ptah-server", "sh.ptah.service.slug": "ptah_happy_ptah_2", "sh.ptah.deployment.id": "2"}, "Mounts": [], "Command": null, "Configs": [], "Secrets": [], "Hostname": "dpl-2.main.ptah-server.server.ptah.local", "Placement": [], "HealthCheck": null}, "RestartPolicy": {"Condition": "any"}}}}	completed	2024-09-01 00:00:00	2024-09-01 00:00:00	[]	2024-09-01 00:00:00	2024-09-01 00:00:00
18	1	3	21	{"serviceId": 2, "dockerName": "svc_2_ptah_ptah_server_wkr_queue", "serviceName": "ptah", "deploymentId": 2}	{"SecretVars": {}, "ReleaseCommand": {"Command": "", "ConfigName": "", "ConfigLabels": {}}, "SwarmServiceSpec": {"Mode": {"Replicated": {"Replicas": 1}}, "Name": "svc_2_ptah_ptah_server_wkr_queue", "Labels": {"sh.ptah.kind": "worker", "sh.ptah.cookie": "8LgT3BqhR6E9CsjUFKvLFZA0eh6PsHOe", "sh.ptah.managed": "1", "sh.ptah.service.id": "2", "sh.ptah.worker.name": "queue", "sh.ptah.process.name": "ptah-server", "sh.ptah.service.slug": "ptah_happy_ptah_2", "sh.ptah.deployment.id": "2"}, "EndpointSpec": {"Ports": []}, "TaskTemplate": {"Networks": [{"Target": "ptah_net", "Aliases": ["queue.ptah-server.server.ptah.local", "dpl-2.queue.ptah-server.server.ptah.local"]}], "ContainerSpec": {"Env": ["APP_ENV=production", "APP_KEY=base64:APP_KEY", "BCRYPT_ROUNDS=12", "DB_CONNECTION=pgsql", "DB_HOST=pool.server.ptah.local", "DB_DATABASE=ptah_sh", "DB_USERNAME=ptah_sh", "DB_PASSWORD=ptah_sh", "LOG_CHANNEL=errorlog", "APP_URL=localhost", "BILLING_ENABLED=false", "VICTORIAMETRICS_URL=http://victoriametrics.server.ptah.local:8428", "PTAH_INTERNAL_DOMAIN=queue.ptah-server.server.ptah.local", "PTAH_HOSTNAME=dpl-2.queue.ptah-server.server.ptah.local", "PTAH_DEPLOYMENT_ID=2", "PTAH_SERVICE_ID=ptah_happy_ptah_2", "PTAH_PROCESS_NAME=ptah-server", "PTAH_WORKER_NAME=queue"], "Args": ["-c", "php artisan config:cache && php artisan queue:work"], "Hosts": ["queue.ptah-server.server.ptah.local"], "Image": "ghcr.io/ptah-sh/ptah-server:latest", "Labels": {"sh.ptah.kind": "worker", "sh.ptah.cookie": "8LgT3BqhR6E9CsjUFKvLFZA0eh6PsHOe", "sh.ptah.managed": "1", "sh.ptah.service.id": "2", "sh.ptah.worker.name": "queue", "sh.ptah.process.name": "ptah-server", "sh.ptah.service.slug": "ptah_happy_ptah_2", "sh.ptah.deployment.id": "2"}, "Mounts": [], "Command": ["sh"], "Configs": [], "Secrets": [], "Hostname": "dpl-2.queue.ptah-server.server.ptah.local", "Placement": [], "HealthCheck": null}, "RestartPolicy": {"Condition": "any"}}}}	completed	2024-09-01 00:00:00	2024-09-01 00:00:00	[]	2024-09-01 00:00:00	2024-09-01 00:00:00
