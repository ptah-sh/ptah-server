...
1	1	1	{"processes": [{"name": "svc", "caddy": [], "ports": [{"targetPort": 80, "publishedPort": 80}, {"targetPort": 443, "publishedPort": 443}, {"targetPort": 2019, "publishedPort": 2019}], "backups": [], "command": "sh /start.sh", "envVars": [{"name": "CADDY_ADMIN", "value": "0.0.0.0:2019"}], "fastCgi": null, "volumes": [{"id": "volume-a1b2c3d4e5f", "name": "data", "path": "/data", "dockerName": "svc_1_caddy_svc_data", "backupSchedule": null}, {"id": "volume-g6h7i8j9k1", "name": "config", "path": "/config", "dockerName": "svc_1_caddy_svc_config", "backupSchedule": null}], "workers": [], "replicas": 1, "dockerName": "svc_1_caddy_svc", "launchMode": "daemon", "secretVars": {"vars": [], "dockerName": null}, "configFiles": [{"path": "/ptah/caddy/tls/.keep", "content": "# Keep this file", "dockerName": "svc_1_caddy_svc_dpl_1_cfg_ptah_caddy_tls_keep"}, {"path": "/start.sh", "content": "# This is the entrypoint for Caddy.\\n# By default, it starts with a blank Caddyfile with a standard \\"Hello from Caddy\\" page.\\n\\nif [ -f \\"/config/caddy/autosave.json\\" ]; then\\n    echo \\"Starting with autosave.json\\"\\n\\n    caddy run --config \\"/config/caddy/autosave.json\\"\\nelse\\n    echo \\"Starting with the default Caddyfile\\"\\n\\n    caddy run --config \\"/etc/caddy/Caddyfile\\"\\nfi", "dockerName": "svc_1_caddy_svc_dpl_1_cfg_start_sh"}], "dockerImage": "caddy:2.8-alpine", "secretFiles": [], "backupVolume": {"id": "volume-l2m3n4o5p6", "name": "backups", "path": "/ptah/backups", "dockerName": "svc_1_caddy_svc_ptah_backups"}, "rewriteRules": [], "redirectRules": [], "releaseCommand": {"command": null, "dockerName": null}, "placementNodeId": 1, "dockerRegistryId": null}], "networkName": "ptah_net", "internalDomain": "caddy.ptah.local"}	2024-09-01 00:00:00	2024-09-01 00:00:00
2	1	2	{"processes": [{"name": "pg", "caddy": [], "ports": [], "backups": [], "command": null, "envVars": [{"name": "POSTGRESQL_USERNAME", "value": "ptah_sh"}, {"name": "POSTGRESQL_PASSWORD", "value": "ptah_sh"}, {"name": "POSTGRESQL_DATABASE", "value": "ptah_sh"}], "fastCgi": null, "volumes": [{"id": "volume-q7r8s9t0a1", "name": "data", "path": "/bitnami/postgresql", "dockerName": "svc_2_ptah_pg_data", "backupSchedule": null}], "workers": [], "replicas": 1, "dockerName": "svc_2_ptah_pg", "launchMode": "daemon", "secretVars": {"vars": [], "dockerName": null}, "configFiles": [], "dockerImage": "bitnami/postgresql:16", "secretFiles": [], "backupVolume": {"id": "volume-h7i8j9k0l1", "name": "backups", "path": "/ptah/backups", "dockerName": "svc_2_ptah_pg_ptah_backups"}, "rewriteRules": [], "redirectRules": [], "releaseCommand": {"command": null, "dockerName": null}, "placementNodeId": 1, "dockerRegistryId": null}, {"name": "pool", "caddy": [], "ports": [], "backups": [], "command": null, "envVars": [{"name": "PGBOUNCER_POOL_MODE", "value": "session"}, {"name": "POSTGRESQL_USERNAME", "value": "ptah_sh"}, {"name": "POSTGRESQL_PASSWORD", "value": "ptah_sh"}, {"name": "POSTGRESQL_DATABASE", "value": "ptah_sh"}, {"name": "POSTGRESQL_HOST", "value": "pg.server.ptah.local"}, {"name": "PGBOUNCER_PORT", "value": "5432"}, {"name": "PGBOUNCER_DATABASE", "value": "ptah_sh"}], "fastCgi": null, "volumes": [], "workers": [], "replicas": 1, "dockerName": "svc_2_ptah_pool", "launchMode": "daemon", "secretVars": {"vars": [], "dockerName": null}, "configFiles": [], "dockerImage": "bitnami/pgbouncer", "secretFiles": [], "backupVolume": null, "rewriteRules": [], "redirectRules": [], "releaseCommand": {"command": null, "dockerName": null}, "placementNodeId": null, "dockerRegistryId": null}, {"name": "app", "caddy": [{"id": "caddy-b2c3d4e5f6", "path": "/*", "domain": "ptah.localhost", "targetPort": 8080, "publishedPort": 80, "targetProtocol": "http"}], "ports": [], "backups": [], "command": null, "envVars": [{"name": "APP_ENV", "value": "production"}, {"name": "APP_KEY", "value": "base64:APP_KEY"}, {"name": "BCRYPT_ROUNDS", "value": "12"}, {"name": "DB_CONNECTION", "value": "pgsql"}, {"name": "DB_HOST", "value": "pool.server.ptah.local"}, {"name": "DB_DATABASE", "value": "ptah_sh"}, {"name": "DB_USERNAME", "value": "ptah_sh"}, {"name": "DB_PASSWORD", "value": "ptah_sh"}, {"name": "LOG_CHANNEL", "value": "errorlog"}, {"name": "APP_URL", "value": "localhost"}, {"name": "BILLING_ENABLED", "value": "false"}], "fastCgi": null, "volumes": [], "workers": [{"name": "schedule", "command": "php artisan config:cache && php artisan schedule:work", "replicas": 1, "dockerName": "svc_2_ptah_app_wkr_schedule"}, {"name": "queue", "command": "php artisan config:cache && php artisan queue:work", "replicas": 1, "dockerName": "svc_2_ptah_app_wkr_queue"}], "replicas": 2, "dockerName": "svc_2_ptah_app", "launchMode": "daemon", "secretVars": {"vars": [], "dockerName": null}, "configFiles": [], "dockerImage": "ghcr.io/ptah-sh/ptah-server:latest", "secretFiles": [], "backupVolume": null, "rewriteRules": [], "redirectRules": [], "releaseCommand": {"command": "php artisan config:cache && php artisan migrate --no-interaction --verbose --ansi --force", "dockerName": "svc_2_dpl_2_release_command"}, "placementNodeId": null, "dockerRegistryId": null}], "networkName": "ptah_net", "internalDomain": "server.ptah.local"}	2024-09-01 00:00:00	2024-09-01 00:00:00
\.
