    ...
    'paddle' => [
        'plans' => [
            [
                ...
                'quotas' => [
                    ...
                    'review_apps' => ['limit' => 30, 'soft' => true, 'reset_period' => null],
        ...
        'trialPlan' => [
            ...
            'quotas' => [
                ...
                'review_apps' => ['limit' => 9, 'soft' => false, 'reset_period' => null],
        ...
        'selfHostedPlan' => [
            ...
            'price_id' => null,
            'quotas' => [
                'nodes' => ['limit' => PHP_INT_MAX, 'soft' => true, 'reset_period' => null],
                'swarms' => ['limit' => 1, 'soft' => false, 'reset_period' => null],
                'services' => ['limit' => PHP_INT_MAX, 'soft' => true, 'reset_period' => null],
                'review_apps' => ['limit' => PHP_INT_MAX, 'soft' => true, 'reset_period' => null],
                'deployments' => ['limit' => PHP_INT_MAX, 'soft' => true, 'reset_period' => 'daily'],
            ],
        ],
    ],
];
