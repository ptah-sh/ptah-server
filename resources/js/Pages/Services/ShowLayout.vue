...
<template>
    <AppLayout title="Dashboard">
        ...
        <template #tabs>
            <LayoutTab :href="route('services.show', $props.service)">
                <template #icon>
                    <svg
                        class="w-6 h-6"
                        aria-hidden="true"
            ...
            <LayoutTab :href="route('services.deployments', $props.service)">
                <template #icon>
                    <svg
            ...
            <LayoutTab :href="route('services.review-apps', $props.service)">
                <template #icon>
                    <svg
                        class="w-6 h-6 text-gray-800 dark:text-white"
                        aria-hidden="true"
                    ...
                    >
                        <path
                            ...
                            stroke-linejoin="round"
                            stroke-width="2"
                            d="M8 8a2 2 0 1 0 0-4 2 2 0 0 0 0 4Zm0 0v8m0 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4Zm8-6a2 2 0 1 0 0-4 2 2 0 0 0 0 4Zm0 0v2a2 2 0 0 1-2 2H8"
                        />
                    </svg>
                </template>

                <template #title> Review Apps </template>
            </LayoutTab>
            <LayoutTab :href="route('services.backups', $props.service)">
                <template #icon>
                    <svg
                        class="w-6 h-6 text-gray-800 dark:text-white"
                        aria-hidden="true"
